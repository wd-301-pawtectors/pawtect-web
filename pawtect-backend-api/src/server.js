...
/* `const PORT = process.env.PORT || 3000;` is setting the value of the `PORT` constant. It is checking
...
or is falsy, it will default to using port 3000. This allows flexibility in specifying the port
